    ...
    public enum NetworkMessageType : byte
{
    ...
    SatelliteComponentStateRequest = 0x46, // [RequesterSteamId(8)][ComponentIndex(1)][Damaged(1)]
    ConsoleStateRequest = 0x47,          // [RequesterSteamId(8)][ConsoleId(4)][StateByte(1)][Payload(N)]
